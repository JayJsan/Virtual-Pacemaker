...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            ${tickdata_name}.AEI_Clock = item->valuedouble;
        }
        // Receive LRI_Clock
        item = cJSON_GetObjectItemCaseSensitive(root, "LRI_Clock");
        if(item != NULL) {
            ${tickdata_name}.LRI_Clock = item->valuedouble;
        }
        // Receive URI_Clock
        item = cJSON_GetObjectItemCaseSensitive(root, "URI_Clock");
        if(item != NULL) {
            ${tickdata_name}.URI_Clock = item->valuedouble;
        }
        // Receive VRP_Clock
        item = cJSON_GetObjectItemCaseSensitive(root, "VRP_Clock");
        if(item != NULL) {
            ${tickdata_name}.VRP_Clock = item->valuedouble;
        }
        // Receive _GO
        ...
        if(item != NULL) {
            ${tickdata_name}._Pacemaker_local_AVI_Clock = item->valuedouble;
        }
        ...
        if(item != NULL) {
            ${tickdata_name}._g34_e3 = item->valueint;
        }
        // Receive _g35
        ...
        if(item != NULL) {
            ${tickdata_name}._g45_e4 = item->valueint;
        }
        // Receive _g46
        ...
        if(item != NULL) {
            ${tickdata_name}._g54_e5 = item->valueint;
        }
        // Receive _g55
        ...
        if(item != NULL) {
            ${tickdata_name}._g77_e1 = item->valueint;
        }
        // Receive _g80
        ...
        if(item != NULL) {
            ${tickdata_name}._g88_e2 = item->valueint;
        }
        // Receive _g9
        ...
        if(item != NULL) {
            ${tickdata_name}._g97_e3 = item->valueint;
        }
        // Receive _g98
        ...
        if(item != NULL) {
            ${tickdata_name}._pg23_e2 = item->valueint;
        }
        // Receive _pg26
        ...
        if(item != NULL) {
            ${tickdata_name}._pg34_e3 = item->valueint;
        }
        // Receive _pg35
        ...
        if(item != NULL) {
            ${tickdata_name}._region0_null_PVARP_Clock = item->valuedouble;
        }
...
void sendVariables(int send_interface) {
    ...
    // Send AEI_Clock
    cJSON_AddItemToObject(root, "AEI_Clock", cJSON_CreateNumber(${tickdata_name}.AEI_Clock));
    // Send LRI_Clock
    cJSON_AddItemToObject(root, "LRI_Clock", cJSON_CreateNumber(${tickdata_name}.LRI_Clock));
    // Send URI_Clock
    cJSON_AddItemToObject(root, "URI_Clock", cJSON_CreateNumber(${tickdata_name}.URI_Clock));
    // Send VRP_Clock
    cJSON_AddItemToObject(root, "VRP_Clock", cJSON_CreateNumber(${tickdata_name}.VRP_Clock));
    // Send _GO
    cJSON_AddItemToObject(root, "_GO", cJSON_CreateBool(${tickdata_name}._GO));
    // Send _Pacemaker_local_AVI_Clock
    cJSON_AddItemToObject(root, "_Pacemaker_local_AVI_Clock", cJSON_CreateNumber(${tickdata_name}._Pacemaker_local_AVI_Clock));
    ...
    // Send _g34_e3
    cJSON_AddItemToObject(root, "_g34_e3", cJSON_CreateBool(${tickdata_name}._g34_e3));
    // Send _g35
    ...
    // Send _g45_e4
    cJSON_AddItemToObject(root, "_g45_e4", cJSON_CreateBool(${tickdata_name}._g45_e4));
    // Send _g46
    ...
    // Send _g54_e5
    cJSON_AddItemToObject(root, "_g54_e5", cJSON_CreateBool(${tickdata_name}._g54_e5));
    // Send _g55
    ...
    // Send _g77_e1
    cJSON_AddItemToObject(root, "_g77_e1", cJSON_CreateBool(${tickdata_name}._g77_e1));
    // Send _g80
    ...
    // Send _g88_e2
    cJSON_AddItemToObject(root, "_g88_e2", cJSON_CreateBool(${tickdata_name}._g88_e2));
    // Send _g9
    ...
    // Send _g97_e3
    cJSON_AddItemToObject(root, "_g97_e3", cJSON_CreateBool(${tickdata_name}._g97_e3));
    // Send _g98
    ...
    // Send _pg23_e2
    cJSON_AddItemToObject(root, "_pg23_e2", cJSON_CreateBool(${tickdata_name}._pg23_e2));
    // Send _pg26
    ...
    // Send _pg34_e3
    cJSON_AddItemToObject(root, "_pg34_e3", cJSON_CreateBool(${tickdata_name}._pg34_e3));
    // Send _pg35
    ...
    cJSON_AddItemToObject(root, "_region0_null_PVARP_Clock", cJSON_CreateNumber(${tickdata_name}._region0_null_PVARP_Clock));
