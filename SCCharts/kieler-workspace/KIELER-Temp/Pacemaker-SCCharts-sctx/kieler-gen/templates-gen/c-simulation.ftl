...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            ${tickdata_name}.PVARP_Clock = item->valuedouble;
        }
        // Receive URI_Clock
        ...
        if(item != NULL) {
            ${tickdata_name}._g32_e3 = item->valueint;
        }
        // Receive _g33
        ...
        if(item != NULL) {
            ${tickdata_name}._g43_e4 = item->valueint;
        }
        // Receive _g44
        ...
        if(item != NULL) {
            ${tickdata_name}._g52_e5 = item->valueint;
        }
        // Receive _g53
        ...
        if(item != NULL) {
            ${tickdata_name}._g67_e1 = item->valueint;
        }
        // Receive _g7
        ...
        if(item != NULL) {
            ${tickdata_name}._g78_e2 = item->valueint;
        }
        // Receive _g8
        ...
        if(item != NULL) {
            ${tickdata_name}._g87_e3 = item->valueint;
        }
        // Receive _g88
        ...
        if(item != NULL) {
            ${tickdata_name}._pg32_e3 = item->valueint;
        }
        // Receive _pg38
        ...
        if(item != NULL) {
            ${tickdata_name}._pg55 = item->valueint;
        }
        // Receive _pg57
        ...
        if(item != NULL) {
            ${tickdata_name}._pg67_e1 = item->valueint;
        }
        // Receive _pg93
...
void sendVariables(int send_interface) {
    ...
    // Send PVARP_Clock
    cJSON_AddItemToObject(root, "PVARP_Clock", cJSON_CreateNumber(${tickdata_name}.PVARP_Clock));
    // Send URI_Clock
    ...
    // Send _g32_e3
    cJSON_AddItemToObject(root, "_g32_e3", cJSON_CreateBool(${tickdata_name}._g32_e3));
    // Send _g33
    ...
    // Send _g43_e4
    cJSON_AddItemToObject(root, "_g43_e4", cJSON_CreateBool(${tickdata_name}._g43_e4));
    // Send _g44
    ...
    // Send _g52_e5
    cJSON_AddItemToObject(root, "_g52_e5", cJSON_CreateBool(${tickdata_name}._g52_e5));
    // Send _g53
    ...
    // Send _g67_e1
    cJSON_AddItemToObject(root, "_g67_e1", cJSON_CreateBool(${tickdata_name}._g67_e1));
    // Send _g7
    ...
    // Send _g78_e2
    cJSON_AddItemToObject(root, "_g78_e2", cJSON_CreateBool(${tickdata_name}._g78_e2));
    // Send _g8
    ...
    // Send _g87_e3
    cJSON_AddItemToObject(root, "_g87_e3", cJSON_CreateBool(${tickdata_name}._g87_e3));
    // Send _g88
    ...
    // Send _pg32_e3
    cJSON_AddItemToObject(root, "_pg32_e3", cJSON_CreateBool(${tickdata_name}._pg32_e3));
    // Send _pg38
    ...
    // Send _pg55
    cJSON_AddItemToObject(root, "_pg55", cJSON_CreateBool(${tickdata_name}._pg55));
    // Send _pg57
    ...
    // Send _pg67_e1
    cJSON_AddItemToObject(root, "_pg67_e1", cJSON_CreateBool(${tickdata_name}._pg67_e1));
    // Send _pg93
