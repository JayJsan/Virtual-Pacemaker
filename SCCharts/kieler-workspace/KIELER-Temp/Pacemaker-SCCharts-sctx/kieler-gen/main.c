    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            for (int i0 = 0; i0 < cJSON_GetArraySize(item); i0++) {
                ...
                model.iface._taken_transitions[i0] = item0->valueint;
            }
        }
    }
...
void sendVariables(int send_interface) {
    ...
    // Send AS
    cJSON_AddItemToObject(root, "AS", cJSON_CreateBool(model.iface.AS));
    // Send VS
    cJSON_AddItemToObject(root, "VS", cJSON_CreateBool(model.iface.VS));
    // Send deltaT
    cJSON_AddItemToObject(root, "deltaT", cJSON_CreateNumber(model.iface.deltaT));
    // Send AP
    cJSON_AddItemToObject(root, "AP", cJSON_CreateBool(model.iface.AP));
    // Send AR
    cJSON_AddItemToObject(root, "AR", cJSON_CreateBool(model.iface.AR));
    // Send VP
    cJSON_AddItemToObject(root, "VP", cJSON_CreateBool(model.iface.VP));
    // Send VR
    cJSON_AddItemToObject(root, "VR", cJSON_CreateBool(model.iface.VR));
    // Send sleepT
    cJSON_AddItemToObject(root, "sleepT", cJSON_CreateNumber(model.iface.sleepT));
    // Send #ticktime
    cJSON_AddItemToObject(root, "#ticktime", cJSON_CreateNumber(_ticktime));
    // Send _Pacemaker_local__Atrig
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig));
    // Send _Pacemaker_local__Atrig1
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig1", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig1));
    // Send _Pacemaker_local__Atrig10
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig10", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig10));
    // Send _Pacemaker_local__Atrig2
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig2", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig2));
    // Send _Pacemaker_local__Atrig3
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig3", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig3));
    // Send _Pacemaker_local__Atrig4
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig4", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig4));
    // Send _Pacemaker_local__Atrig5
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig5", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig5));
    // Send _Pacemaker_local__Atrig6
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig6", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig6));
    // Send _Pacemaker_local__Atrig7
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig7", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig7));
    // Send _Pacemaker_local__Atrig8
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig8", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig8));
    // Send _Pacemaker_local__Atrig9
    cJSON_AddItemToObject(root, "_Pacemaker_local__Atrig9", cJSON_CreateBool(model.iface._Pacemaker_local__Atrig9));
    // Send _region0_Main_AVI_Clock
    cJSON_AddItemToObject(root, "_region0_Main_AVI_Clock", cJSON_CreateNumber(model.iface._region0_Main_AVI_Clock));
    // Send _region0_Main_AVI_Stop
    cJSON_AddItemToObject(root, "_region0_Main_AVI_Stop", cJSON_CreateBool(model.iface._region0_Main_AVI_Stop));
    // Send _region0_Main_VEvents_Clock
    cJSON_AddItemToObject(root, "_region0_Main_VEvents_Clock", cJSON_CreateNumber(model.iface._region0_Main_VEvents_Clock));
    // Send _region0_Main_VEvents_Stop
    cJSON_AddItemToObject(root, "_region0_Main_VEvents_Stop", cJSON_CreateBool(model.iface._region0_Main_VEvents_Stop));
    // Send _taken_transitions
    array = cJSON_CreateArray();
    for (int i0 = 0; i0 < 17; i0++) {
        cJSON *item0 = cJSON_CreateNumber(model.iface._taken_transitions[i0]);
