...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            ${tickdata_name}.n_pace = item->valueint;
        }
        // Receive pace
        item = cJSON_GetObjectItemCaseSensitive(root, "pace");
        if(item != NULL) {
            ${tickdata_name}.pace = item->valueint;
        }
        // Receive sleepT
        ...
        if(item != NULL) {
            ${tickdata_name}._SCChart_local__Atrig = item->valueint;
        }
        // Receive _TERM
        ...
        if(item != NULL) {
            ${tickdata_name}._g11_e2 = item->valueint;
        }
        // Receive _g13
        ...
        if(item != NULL) {
            ${tickdata_name}._g20_e3 = item->valueint;
        }
        // Receive _g24
        ...
        if(item != NULL) {
            ${tickdata_name}._g5_e1 = item->valueint;
        }
        // Receive _g7
        ...
        if(item != NULL) {
            ${tickdata_name}.c = item->valuedouble;
        }
    }
...
void sendVariables(int send_interface) {
    ...
    // Send n_pace
    cJSON_AddItemToObject(root, "n_pace", cJSON_CreateBool(${tickdata_name}.n_pace));
    // Send pace
    cJSON_AddItemToObject(root, "pace", cJSON_CreateBool(${tickdata_name}.pace));
    // Send sleepT
    ...
    cJSON_AddItemToObject(root, "_SCChart_local__Atrig", cJSON_CreateBool(${tickdata_name}._SCChart_local__Atrig));
    // Send _TERM
    ...
    // Send _g11_e2
    cJSON_AddItemToObject(root, "_g11_e2", cJSON_CreateBool(${tickdata_name}._g11_e2));
    // Send _g13
    ...
    // Send _g20_e3
    cJSON_AddItemToObject(root, "_g20_e3", cJSON_CreateBool(${tickdata_name}._g20_e3));
    // Send _g24
    ...
    // Send _g5_e1
    cJSON_AddItemToObject(root, "_g5_e1", cJSON_CreateBool(${tickdata_name}._g5_e1));
    // Send _g7
    ...
    // Send c
    cJSON_AddItemToObject(root, "c", cJSON_CreateNumber(${tickdata_name}.c));
